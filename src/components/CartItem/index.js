...
class CartItem extends Component {
  ...
  componentDidMount() {
    ...
    this.setState({totalOrderCost, quantity})
  }
    ...
    if (quantity > 1) {
      ...
      this.setState(
        prev => ({
          ...
          totalOrderCost: prev.totalOrderCost - cost,
        }),
  ...
  render() {
    ...
    const {totalOrderCost, quantity} = this.state
    return (
      <>
        <li className="mobile-list-cart-item">
          ...
          <div>
            ...
            <p testid="total-amount" className="cart-item-cost">
              <span>₹</span>
              {totalOrderCost}
            </p>
          </div>
